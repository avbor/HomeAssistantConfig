        ...
        try:
            ...
            for interface_id, interface_data in interface_info.items():
                ...
                if interface_id == wan_interface:
                    ...
                    port_block = interface_data["port"]
                    if isinstance(port_block, dict):
                        for port_id, port_data in port_block.items():
                        ...
                        _LOGGER.warning("Port data is not a dict for interface '%s': %s", interface_id, port_block)
