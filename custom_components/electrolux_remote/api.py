...
class TestApi(ApiInterface):
    ...
    def __init__(self, host: str, username: str, password: str, appcode: str, session: ClientSession):
        self.devices = [
            ...
            #  'online': '1', 'lock': '0'},
            {'tempid': '78750', 'mode': '2', 'current_temp': '75', 'temp_goal': '75', 'timer': '0', 'timer_hours': '0',
             'timer_minutes': '0', 'clock_hours': '0', 'clock_minutes': '52', 'self_clean': '0', 'volume': '100',
             'error': '0', 'type': 'centurio', 'code': '0', 'self_clean_state': 'disabled', 'economy_morning': '0',
             'economy_evening': '0', 'economy_pause': '0', 'power_per_h_1': '1500', 'power_per_h_2': '2000',
             'tariff_1': '0', 'tariff_2': '0', 'tariff_3': '0', 'minutes_diff': '-9', 'timezone': '0',
             'timer_hours_store': '0', 'timer_minutes_store': '6', 'seconds_diff': '64260', 'uid': '78750',
             'mac': 'set', 'room': 'Симоновский 89', 'sort': '0', 'curr_slot': '0', 'active_slot': '0',
             'curr_scene': '0', 'curr_scene_id': '0', 'wait_slot': '0', 'curr_slot_dropped': '0',
             'curr_scene_dropped': '0', 'online': '0', 'undefined1': '0', 'undefined2': '0', 'undefined3': '4',
             'undefined4': '0', 'uv': '0', 'ion': '0', 'timer_off': '1', 'timer_on': '1', 'co2_sensor_connect': '1',
             'lock': '0', 'state': '1', 'indoor': '0', 'timer_inf': '1', 'timer_auto': '1', 'timer_sleep': '0',
             'error_code': '1', 'filter_s': '0', 'timer_on_hours': '6', 'timer_on_minutes': '0', 'timer_off_hours': '0',
             'timer_off_minutes': '0', 'hours': '18', 'minutes': '8', 'pm2_5_index': '14', 'co2date1': '8',
             'co2date2': '3', 'speed': '2', 'windows_temp': '24', 'ptc_heat': '0', 'slop': '0'}
        ]
